function Tileset(url) {
	...
	this.image.onload = function() {
		...
		this.referenceDuTileset.largeur = this.width / tailleTuile;
	}
...
Tileset.prototype.dessinerTile = function(numero, context, xDestination, yDestination) {
	...
	context.drawImage(this.image, xSource, ySource, tailleTuile, tailleTuile, xDestination, yDestination, tailleTuile, tailleTuile);
}
