...
function couleurFond(couleur) {
	...
	context.fillRect(0,0, canvasLargeur, canvasHauteur); // 0,0 sont les coordonnées x,y du coin supérieur haut du rectangle à remplir, les autres chiffre sont la largeur et la hauteur
