...
function bloqueTuiles() { // on va parcourir les cartes pour vérifier qi on touche une tuile interdite (appelée dans la fonction animePerso du fichier animation.js)
