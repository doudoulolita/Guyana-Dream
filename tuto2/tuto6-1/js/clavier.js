...
function persoBouge(e) {
	...
	changePose(); // appel de la fonction qui passe d'une pose à l'autre pour simuler le mouvement 

	//déplacements du personnage en fonction des touches

	for (i=0; i<touchesDeplace.length; i++) {

		deplacement(e, touchesDeplace[i]); // appel de la fonction de déplacement lors de l'appui sur les touches
