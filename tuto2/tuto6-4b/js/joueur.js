...
let dir=0; // la direction 0 correspond à la première ligne de la spritesheet, donc de face
...
joueur = joueurs[0]; // initalise le joueur en prenant le dernier du tableau des joueurs
