...
function dessinePerso(x, y, pose) {
	context.clearRect(0, 0, largeurCanvas, hauteurCanvas);
	context.drawImage(joueur, largeurPerso*pose, hauteurPerso, largeurPerso, hauteurPerso,  x, y, largeurPerso, hauteurPerso);
}
...
function animePerso() {
	dessinePerso(x, y, Math.floor(pose)); // appel de la fonction qui dessine le personnage, en transformant le chiffre de la pose en entier
