...
function animePerso(joueur) {

	dessinePerso(joueur, context[2], joueur.posX, joueur.posY, joueur.largeur, joueur.hauteur, Math.floor(joueur.pose), dir); // appel de la fonction qui dessine le PNJ, en transformant le chiffre de la pose en entier
