var tempsJeu = 80000; // temps au bout du quel on lancera la fonction chrono()
...
function chrono() {
	setTimeout(function() { // cette fonction se lancera quand le temps décidé sera écoulé
		...
		pnj.posX2= 0 ; pnj.posY2= pnj.departY; dirPnj=1; pnj.v=0; // on place le pnj un peu plus bas à gauche, regardant de face
