...
function dessineCarte() {
	for(i=0; i<carte1.length; i++) {//on parcourt chaque numéro de la ligne (soit les colonnes de la carte)
		dessineTuiles(carte1[i], tailleTuile*i, 0)// cartes[numCarte-1][j][i] représente le numéro de la tuile de la j ème ligne et de la i ème colonne qu'on positionne en ajoutant une largeur de tuile à chaque fois en abcisse et une largeur de tuile à chaque fois en ordonnée
	}
}
