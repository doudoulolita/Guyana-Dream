...
function ecranFinJeu() { // fonction affichant un écran donnant les scores (appelée dans la fonction chrono du fichier temps.js)
	context[0].clearRect(0, 0, carte1[0].length *tailleTuile, carte1.length*tailleTuile); // efface la carte sur le premier canvas
	context[1].clearRect(0, 0, carte1[0].length *tailleTuile, carte1.length*tailleTuile); // efface les bulles de dialogues
	context[4].clearRect(0, 0, carte1[0].length *tailleTuile, carte1.length*tailleTuile); // efface le canvas des textes
