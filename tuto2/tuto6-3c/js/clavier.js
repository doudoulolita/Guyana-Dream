var touchesDeplace = ["37","38","39","40"]; // tableau des touches du pavé directionnel

function persoBouge(e) { // fonction qui sera appelée lors de l'évènement que constitue l'appui sur une touche
