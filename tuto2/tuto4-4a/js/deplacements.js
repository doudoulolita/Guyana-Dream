function deplacement(e, touche) {
	switch(touche) {
 	...
 	if(e.keyCode == touche) { // si la touche en paramètre est pressée
		...
		if(touche==37 || touche==39) {	x = x + vitesse; dir = direct; } // changement de la coordonnée x et personnage avec le bon profil 
	...
	// fonction définie dans le fichier collision-decor.js
